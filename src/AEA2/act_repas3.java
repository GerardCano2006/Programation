...
public class act_repas3 {
    public static void main(String[] args) {
        ...
        if (files1 != files2 || columnes1 != columnes2) {
            System.out.println("ERROR: Les matrius han de tenir les mateixes dimensions per a ser sumades.");
            System.out.println("De quàntes files vols la 2a matriu? " + "(" + files1 + ")");
            files2 = lector.nextInt();

            System.out.println("De quàntes columnes vols la 2a matriu? " + "(" + columnes1 + ")");
